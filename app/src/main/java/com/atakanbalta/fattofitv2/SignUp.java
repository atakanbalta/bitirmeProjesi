...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (numberRows >= 1) {
            // Sign up
            Toast.makeText(this, "Deneyimden bir kaç adım uzaklıktasınız...", Toast.LENGTH_LONG).show();
    ...
    public void signUpSubmit() {
        ...
        if (stringEmail.isEmpty() || stringEmail.startsWith(" ")) {
            errorMessage = "E-mail adresini giriniz.";
        }
        ...
        try {
            ...
            errorMessage = "Doğum gününüzü giriniz.";
        }
        ...
        if (errorMessage.isEmpty()) {
            ...
            // Input for goal
            java.text.SimpleDateFormat tf = new SimpleDateFormat("yyyy-MM-dd");
